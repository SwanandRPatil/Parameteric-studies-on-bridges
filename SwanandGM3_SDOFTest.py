...
def groundMotion(delta_t, duration, GMparameter1, GMparameter2, GMparameter3, doPlotting, counter, NonStationarity):
    ...
    if GMparameter2 == 1.0:
        ...
        targetVariance = GMparameter3 * 0.453489688
    elif GMparameter2 == 3.0:
        targetVariance = GMparameter3 * 0.272348375
    elif GMparameter2 == 4.0:
        targetVariance = GMparameter3 * 0.182576966
    elif GMparameter2 == 0.5:
        targetVariance = GMparameter3 * 2.095291297
    elif GMparameter2 == 3.5:
        targetVariance = GMparameter3 * 0.220933744
    elif GMparameter2 == 2.0131684841794817:
        targetVariance = GMparameter3 * 0.449925001
    elif GMparameter2 == 2.5:
        targetVariance = GMparameter3 * 0.344648256
    elif GMparameter2 == 1.5:
        targetVariance = GMparameter3 * 0.635405998
    ...
    rvFileName = "rv_realizationsSDOFTest.txt"
    pulseArray = []
    ...
    for i in range(totalNumPulses):
        ...
        for j in range(nintervals):
            t[j] = j * delta_t
            ax[j] += pulseArray[i] * filter(nonstationarity(t[j], duration, startOmega, endOmega), damping, t[j]-kickTime)
